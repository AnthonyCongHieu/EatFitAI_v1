// Màn hình Thành tích - Redesigned v?i UI/UX hi?n d?i
// Inspired by Duolingo, Strava, và các fitness apps hàng d?u
...
const AchievementsScreen = (): React.ReactElement => {
  ...
  // Tính toán s? thành tích dã m? khóa
  const unlockedCount = achievements.filter((a) => a.unlockedAt).length;
  const totalCount = achievements.length;

  // Gradient colors cho các thành tích - s? d?ng theme
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statItem}>
            ...
            <ThemedText style={styles.statLabel}>T?ng ngày</ThemedText>
          </View>
          <View style={[styles.statDivider, { backgroundColor: 'rgba(255,255,255,0.2)' }]} />
          <View style={styles.statItem}>
  ...
  const renderSectionTitle = () => (
    <Animated.View entering={FadeIn.delay(150)} style={styles.sectionHeader}>
      ...
      <ThemedText variant="caption" color="textSecondary">
        {unlockedCount} / {totalCount} dã d?t
      </ThemedText>
    </Animated.View>
  );
  ...
  return (
    <Screen scroll={false} style={styles.container}>
      <AppHeader
        title="Thành tích"
        subtitle="Hành trình s?c kh?e c?a b?n"
