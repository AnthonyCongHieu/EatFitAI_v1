...
const S = StyleSheet.create({
  ...
  headerTitle: { fontSize: 17, fontFamily: 'BeVietnamPro_600SemiBold', color: P.primary, letterSpacing: -0.3, flex: 1, textAlign: 'center' },
  ...
  heroLabel: { fontSize: 12, fontFamily: 'BeVietnamPro_700Bold', color: P.primaryLight, letterSpacing: 2, opacity: 0.9, marginBottom: 10 },
  streakRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 22 },
  streakNumber: { fontSize: 62, fontFamily: 'BeVietnamPro_700Bold', color: P.primaryLight, lineHeight: 66 },
  streakCopy: { flex: 1, gap: 4 },
  streakText: { fontSize: 20, fontFamily: 'BeVietnamPro_700Bold', color: P.onSurface },
  streakSubtext: { fontSize: 13, fontFamily: 'BeVietnamPro_600SemiBold', color: P.textMuted },
  ...
  levelTitle: { fontSize: 19, fontFamily: 'BeVietnamPro_700Bold', color: '#fff', flex: 1, lineHeight: 25 },
  levelProgressLabels: { flexDirection: 'row', justifyContent: 'space-between' },
  levelProgressText: { fontSize: 15, fontFamily: 'BeVietnamPro_700Bold', color: P.onSurface },
  levelProgressPercent: { fontSize: 15, fontFamily: 'BeVietnamPro_700Bold', color: P.primary },
  ...
  sectionLabel: { fontSize: 12, fontFamily: 'BeVietnamPro_700Bold', color: P.slate500, letterSpacing: 1.5, paddingLeft: 4 },
  ...
  activityText: { fontSize: 15, fontFamily: 'BeVietnamPro_700Bold', color: '#fff' },
  ...
  badgesTitle: { fontSize: 20, fontFamily: 'BeVietnamPro_700Bold', color: '#fff' },
  badgesCount: { fontSize: 20, fontFamily: 'BeVietnamPro_500Medium', color: P.primaryLight },
  viewAllBtn: { fontSize: 15, fontFamily: 'BeVietnamPro_700Bold', color: P.primary },
  ...
  badgeName: { fontSize: 15, fontFamily: 'BeVietnamPro_700Bold', color: '#fff', textAlign: 'center', marginBottom: 6 },
  badgeStatus: { fontSize: 11, fontFamily: 'BeVietnamPro_700Bold', color: P.primary, letterSpacing: 1 },
  questsContainer: { backgroundColor: P.surface, borderRadius: 24, padding: 22 },
  questsTitle: { fontSize: 20, fontFamily: 'BeVietnamPro_700Bold', color: '#fff', marginBottom: 18 },
  ...
  questName: { fontSize: 15, fontFamily: 'BeVietnamPro_700Bold', color: '#fff' },
  questReward: { fontSize: 13, color: P.onSurfaceVariant, marginTop: 3 },
  questProgress: { fontSize: 13, fontFamily: 'BeVietnamPro_700Bold', color: '#fff' },
  ...
  questCompleted: { fontSize: 13, fontFamily: 'BeVietnamPro_700Bold', color: P.primary },
});
