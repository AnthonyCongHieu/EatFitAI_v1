...
const VisionHistoryScreen = (): JSX.Element => {
    ...
    const renderSectionHeader = ({ section: { title } }: { section: { title: string } }) => (
        <View style={styles.sectionHeader}>
            <ThemedText variant="h4" color="textSecondary" style={{ textTransform: 'uppercase', fontSize: 13, letterSpacing: 1 }}>
                {title}
            </ThemedText>
        </View>
    );
        ...
        <Screen style={styles.container}>
            ...
            {loading ? (
                ...
                <View style={styles.center}>
                    ...
                    <Button title="Thử lại" onPress={loadHistory} variant="secondary" style={{ marginTop: 16 }} />
                </View>
            ) : (
                <SectionList
                    sections={sections}
                    ...
                    ListEmptyComponent={
                        <View style={styles.center}>
                            ...
                            <ThemedText color="textSecondary" style={{ marginTop: 16 }}>Chưa có lịch sử nhận diện nào</ThemedText>
                        </View>
                    }
                />
            )}
