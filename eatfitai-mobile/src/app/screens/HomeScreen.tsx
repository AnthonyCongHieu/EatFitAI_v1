...
const HomeScreen = (): JSX.Element => {
  ...
  const handleAddOption = useCallback((option: AddOption) => {
    setShowAddModal(false);
    let message = 'Dang mo chuc nang';
    if (option === 'search') {
      message = 'Tim mon co san (se thuc hien o buoc tiep theo)';
    } else if (option === 'custom') {
      message = 'Tao mon thu cong (se thuc hien o buoc tiep theo)';
    } else {
      message = 'Goi y AI (se thuc hien o buoc tiep theo)';
    }
