export const vi = {
  ...
  auth: {
    ...
    loginSuccess: 'Đăng nhập thành công rồi nha! 🎉',
    registerSuccess: 'Đăng ký tài khoản thành công rồi! 🎉',
    googleLoginSuccess: 'Đăng nhập Google thành công rồi nha! 🎉',
    emailExists: 'Email này đã được sử dụng mất rồi',
    useAnotherEmail: 'Bạn vui lòng sử dụng một email khác hoặc đăng nhập nha',
    invalidCredentials: 'Email hoặc mật khẩu chưa đúng rồi. Bạn kiểm tra lại giúp Capy nhé! 🧐',
    checkCredentials: 'Bạn kiểm tra lại email và mật khẩu giúp tụi mình nha',
    invalidEmail: 'Email chưa đúng định dạng rồi',
    checkEmailFormat: 'Bạn kiểm tra lại cấu trúc email (ví dụ: name@email.com) nha',
    passwordTooShort: 'Mật khẩu cần tối thiểu 6 ký tự nè',
    passwordRequirements: 'Mật khẩu cần có cả chữ hoa, chữ thường và số nha',
    passwordMismatch: 'Mật khẩu nhập lại chưa khớp rồi',
    nameTooShort: 'Tên hiển thị cần tối thiểu 2 ký tự nè',
    registerFailed: 'Đăng ký chưa thành công rồi! 😢',
    loginFailed: 'Đăng nhập chưa được rồi! 😢',
    googleLoginFailed: 'Đăng nhập Google chưa thành công rồi! 😢',
