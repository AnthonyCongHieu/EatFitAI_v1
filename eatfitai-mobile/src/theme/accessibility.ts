...
export const a11yHome = {
  ...
  macroCard: {
    protein: (value: number, target?: number) =>
      target ? `Protein: ${value} trong ${target} gram` : `Protein: ${value} gram`,
    carbs: (value: number, target?: number) =>
      target ? `Carbs: ${value} trong ${target} gram` : `Carbs: ${value} gram`,
    fat: (value: number, target?: number) =>
      target ? `Chất béo: ${value} trong ${target} gram` : `Chất béo: ${value} gram`,
  },
  streakCard: {
...
export const a11yDiary = {
  ...
  mealSection: {
    label: (meal: string, calories: number) => `Bữa ${meal}, tổng ${calories} calo`,
