...
const TRANSLATIONS: Record<string, string> = {
    ...
    'Maintaining consistent calorie intake is crucial for achieving your goals': 'Duy trì lượng calories ổn định rất quan trọng để đạt mục tiêu',

    'Increase protein by': 'Tăng protein thêm',
    'Add lean meats, fish, eggs, or legumes': 'Thêm thịt nạc, cá, trứng hoặc đậu',
    'Adequate protein supports muscle maintenance and satiety': 'Protein đầy đủ hỗ trợ duy trì cơ bắp và no lâu',
    ...
    'Balanced carbs provide sustained energy': 'Carbs cân bằng cung cấp năng lượng bền vững',

    'Adjust fat intake': 'Điều chỉnh lượng chất béo',
    'Choose healthy fats from nuts, avocados, and olive oil': 'Chọn chất béo lành mạnh từ hạt, bơ và dầu ô liu',
    'Healthy fats support hormone production and nutrient absorption': 'Chất béo lành mạnh hỗ trợ sản xuất hormone và hấp thu dinh dưỡng',
