...
export const handleApiErrorSilent = (error: any): ApiError => {
    ...
    switch (status) {
        case 401: return { type: 'unauthorized', status };
        case 403: return { type: 'forbidden', status };
        case 404: return { type: 'not_found', status };
        case 422: return { type: 'validation', status };
        case 500:
        case 502:
        case 503:
        case 504: return { type: 'server_error', status };
