...
export const VoiceSheet = ({ visible, onClose }: VoiceSheetProps): JSX.Element => {
  ...
  const styles = StyleSheet.create({
    ...
    waveInner: {
      ...
      height: 120,
      borderRadius: 60,
      backgroundColor: (isRecording ? theme.colors.error : theme.colors.primary) + '30',
    },
    duration: {
  ...
  return (
    <BottomSheet visible={visible} onClose={handleClose} height={480}>
      <View style={styles.container}>
        ...
        <Pressable style={styles.waveContainer} onPress={handleToggleRecording}>
          ...
          {isRecording && (
            <ThemedText variant="caption" color="error" style={styles.duration}>
