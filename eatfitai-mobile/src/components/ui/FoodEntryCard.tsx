...
const getFoodEmoji = (foodName: string): string => {
  ...
  // Rau củ
  if (name.includes('rau') || name.includes('salad') || name.includes('vegetable'))
    return '🥗';
  ...
  if (name.includes('nước') || name.includes('water') || name.includes('juice'))
    return '🧃';
        ...
        <View style={styles.content}>
          ...
          <View style={styles.macroRow}>
            ...
            <View
              style={[
                styles.macroChip,
                { backgroundColor: isDark ? '#1A2A50' : '#E0F2FE' },
              ]}
            >
            ...
            <View
              style={[
                styles.macroChip,
                { backgroundColor: isDark ? '#2A2818' : '#FEF3C7' },
              ]}
            >
            ...
            <View
              style={[
                styles.macroChip,
                { backgroundColor: isDark ? '#2A1A28' : '#FCE7F3' },
              ]}
            >
