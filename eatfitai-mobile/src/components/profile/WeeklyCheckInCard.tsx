...
export const WeeklyCheckInCard = ({
  ...
  const { currentWeek, isLoading, fetchCurrentWeek, summary, fetchSummary } =
    useWeeklyStore();
    ...
    return (
      <View style={styles.container}>
        <View
          style={[
            styles.card,
            { backgroundColor: theme.colors.card, padding: theme.spacing.xl },
          ]}
        >
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statItem}>
                  ...
                  <View style={styles.changeIndicator}>
                    <ThemedText
                      style={{
                        color: currentWeek.checkIn.isOnTrack ? '#4CAF50' : '#FF9800',
                      }}
                    >
                      {currentWeek.checkIn.isOnTrack
                        ? '✓ Đúng tiến độ'
                        : '⚠️ Cần điều chỉnh'}
                    </ThemedText>
                  </View>
