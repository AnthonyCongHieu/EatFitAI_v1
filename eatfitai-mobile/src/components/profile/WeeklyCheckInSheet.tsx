...
export const WeeklyCheckInSheet = ({
  ...
  const { currentWeek, isSubmitting, submitCheckIn, error, clearError } =
    useWeeklyStore();
      ...
      >
        <View style={styles.container}>
          ...
          {currentWeek?.previousWeight && (
            <Animated.View entering={FadeInUp.delay(200)} style={styles.previousWeight}>
              ...
              <ThemedText weight="600">
                {currentWeek.previousWeight.toFixed(1)} kg
              </ThemedText>
            </Animated.View>
          )}
          ...
          <View style={styles.buttonRow}>
            <Button title="Hủy" onPress={onClose} variant="ghost" style={{ flex: 1 }} />
            <Button
