...
$env:EXPO_PUBLIC_API_BASE_URL = 'http://10.0.2.2:5247'
$env:EXPO_PUBLIC_API_PORT = '5247'
$env:EXPO_PUBLIC_API_SCHEME = 'http'
...
Write-Host "[start-mobile-local] API target: $($env:EXPO_PUBLIC_API_BASE_URL)"
