...
builder.Services.AddScoped<IMealBudgetService, MealBudgetService>();
builder.Services.AddScoped<IDailyNutritionLoopService, DailyNutritionLoopService>();
builder.Services.AddSingleton<IFlexibleNutritionPlanService, FlexibleNutritionPlanService>();
