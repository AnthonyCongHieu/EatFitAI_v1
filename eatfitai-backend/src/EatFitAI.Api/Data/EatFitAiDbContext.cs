...
using EatFitAI.Api.Your_Models_Folder;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-U9R2KGG0;Database=EatFitAI;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChiSoCoThe>(entity =>
        {
            entity.HasKey(e => e.MaChiSo).HasName("PK__ChiSoCoT__EBA18E152B2FE250");
        ...
        {
            entity.HasKey(e => e.MaCongThuc).HasName("PK__CongThuc__6E223AF790E3CC13");
        ...
        {
            entity.HasKey(e => e.MaBuaAn).HasName("PK__LoaiBuaA__AE9738D9BE14B1F1");
        ...
        {
            entity.HasKey(e => e.MaMonNguoiDung).HasName("PK__MonNguoi__C8B7FDECDB114611");
        ...
        {
            entity.HasKey(e => e.MaMucDo).HasName("PK__MucDoVan__3EAECAA4E1A96D61");
        ...
        {
            entity.HasKey(e => e.MaMucTieu).HasName("PK__MucTieu__E587A329F5CA3974");
        ...
        {
            entity.HasKey(e => e.MaMucTieuDd).HasName("PK__MucTieuD__0DC0CD6A483F9842");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__C539D76232CD88BE");

            entity.ToTable("NguoiDung");

            entity.HasIndex(e => e.Email, "UQ__NguoiDun__A9D10534B8BF6E35").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaNguyenLieu).HasName("PK__NguyenLi__C751935549D41C40");
        ...
        {
            entity.HasKey(e => e.MaNhanDien).HasName("PK__NhanDien__B0D88F63D9BFD9E4");
        ...
        {
            entity.HasKey(e => e.MaGoiYai).HasName("PK__NhatKyAI__6E0EE849B4F2D6BF");
        ...
        {
            entity.HasKey(e => e.MaNhatKy).HasName("PK__NhatKyAn__E42EF42EEAF88BEE");
        ...
        {
            entity.HasKey(e => e.MaThucPham).HasName("PK__ThucPham__3E4339C698EC8324");
