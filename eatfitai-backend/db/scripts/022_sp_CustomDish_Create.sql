CREATE OR ALTER PROCEDURE dbo.sp_CustomDish_Create
...
BEGIN
    ...
    -- Ingredients JSON format: [{ "foodId": "GUID or null", "name": "text", "quantityGrams": 100.0, "caloriesKcal": 123.45, "proteinGrams": 10.0, "carbohydrateGrams": 20.0, "fatGrams": 5.0 }]
