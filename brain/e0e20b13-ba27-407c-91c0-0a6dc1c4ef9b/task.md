# Task: Reinstall Open Design (nexu-io/open-design)

- [x] Stop any active processes related to Open CoDesign or Open Design
- [x] Run the uninstaller for Open CoDesign (`D:\OpenCoDesign\Uninstall Open CoDesign.exe`)
...
- [/] Download `open-design-0.8.0-win-x64-setup.exe` from GitHub releases
