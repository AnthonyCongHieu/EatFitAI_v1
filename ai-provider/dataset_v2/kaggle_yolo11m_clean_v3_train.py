...
DATASET_DIR = KAGGLE_WORKING / os.environ.get("EATFITAI_YOLO_DATASET_DIR_NAME", "eatfitai_clean_v3")
RUN_PROJECT = KAGGLE_WORKING / "runs" / "food-detection"
RUN_NAME = os.environ.get("EATFITAI_YOLO_RUN_NAME", "yolo11m-eatfitai-clean-v3")
