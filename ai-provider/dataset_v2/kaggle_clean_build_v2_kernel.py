...
CLEAN_MAX_IMAGES = int(os.environ.get("EATFITAI_CLEAN_MAX_IMAGES", "40000"))
CLEAN_MIN_FREE_GB_AFTER_BUILD = float(os.environ.get("EATFITAI_CLEAN_MIN_FREE_GB_AFTER_BUILD", "4"))

CLEAN_SOURCE_POLICY = os.environ.get("EATFITAI_CLEAN_SOURCE_POLICY", "clean_candidate_sources_v2_2026-05-13.csv")
CLEAN_TAXONOMY = os.environ.get("EATFITAI_CLEAN_TAXONOMY", "class_taxonomy.clean_v2_2026-05-13.yaml")
